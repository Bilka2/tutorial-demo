script.on_event(defines.events.on_player_changed_position, function(event)
    ...
    player.create_local_flying_text{text = "Big STOMP", position = player.position}
end)
...
script.on_event(defines.events.on_player_created, function(e)
    ...
    frame.add({type = "label", caption = "Try walking around :)"})
    frame.add({type = "button", caption = "Let me out!", name = "finish"})
